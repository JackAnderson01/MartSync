...
WSGI_APPLICATION = 'martsync.wsgi.application'
...
RATELIMIT_VIEW = 'users.views.ratelimit_none'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER  = 'professorcoding123@gmail.com'
